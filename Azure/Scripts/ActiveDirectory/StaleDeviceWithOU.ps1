...
$inactiveComputers = Get-ADComputer -Filter {LastLogonDate -lt $inactiveDate} -Properties LastLogonDate, DistinguishedName | 
    Select-Object Name, LastLogonDate, @{Name='OU';Expression={($_.DistinguishedName -split ',OU=')[1]}}
