...
## 9. Enable Auto Unlock for Data Volume
...
## 10. Verify Auto Unlock is Enabled
```powershell
...
## 12. Verify BitLocker Status on All Volumes
```powershell
Get-BitLockerVolume
```
...
## 13. Retrieve Recovery Key from Server
```powershell
...
## 14. Verify key is in Active Directory
