...
SET IMAGEDRIVE="E:\imagedrive"

:: Create an array of files
set i=0
for %%a in (E:\images\images\*) do (
    set /A i+=1
    set "file[!i!]=%%~a"
)
...
ECHO Dism /Mount-Image /ImageFile:%selectedFile%  /index:1 /MountDir:E:\images\mount"
Dism /Mount-Image /ImageFile:%selectedFile%  /index:1 /MountDir:E:\images\mount
pause
goto MainMenu
...
set i=0
for /D %%a in (E:\images\drivers\*) do (
    set /A i+=1
    set "folder[!i!]=%%~a"
)
...
echo DISM /Image:E:\images\Mount /Add-Driver /Driver:%selectedFolder% /recurse /ForceUnsigned
DISM /Image:E:\images\Mount /Add-Driver /Driver:%selectedFolder% /recurse /ForceUnsigned
...
if "%choice%"=="1" (
    ...
    Dism /Unmount-Image /MountDir:E:\images\mount /commit
) else (
    echo Running command for Discard Drivers
    Dism /Unmount-Image /MountDir:E:\images\mount /discard
)
pause
goto MainMenu
...
ECHO =========================================================
ECHO CALL DISM /export-image /sourceimagefile:E:\source\Windows%edition%\%build%\install.wim /sourceindex:%vIndex% /DestinationImageFile:E:\Images\Windows-%Edition%-%Name%-%build%.wim
CALL DISM /export-image /sourceimagefile:E:\source\Windows%edition%\%build%\install.wim /sourceindex:%vIndex% /DestinationImageFile:E:\Images\Windows-%Edition%-%
CLS
ECHO.
ECHO =========================================================
ECHO Mounting WIM File
ECHO =========================================================
ECHO Dism /Mount-Image /ImageFile:E:\Images\Images\Windows-%Edition%-%Name%-%build%.wim  /index:1 /MountDir:"E:\Images\mount"
ECHO ATTRIB -h -a -s E:\Images\Mount\Windows\System32\Recovery\winre.wim
Dism /Mount-Image /ImageFile:E:\Images\Images\Windows-%Edition%-%Name%-%build%.wim  /index:1 /MountDir:"E:\Images\mount"
ATTRIB -h -a -s E:\Images\Mount\Windows\System32\Recovery\winre.wim
CLS
ECHO.
ECHO =========================================================
ECHO Mounting WINRE File
ECHO =========================================================
ECHO CALL DISM /Mount-Wim /WimFile:E:\Images\Mount\Windows\System32\Recovery\winre.wim /index:1 /MountDir:E:\Images\WinREMount
CALL DISM /Mount-Wim /WimFile:E:\Images\Mount\Windows\System32\Recovery\winre.wim /index:1 /MountDir:E:\Images\WinREMount
CLS
ECHO.
ECHO =========================================================
ECHO Applying Drivers
ECHO =========================================================
ECHO DISM /image:E:\Images\WinREMount /Add-Driver /Driver:E:\Images\Drivers\WinPE /recurse /ForceUnsigned
ECHO DISM /image:E:\Images\Mount /Add-Driver /Driver:E:\Images\Drivers\RSTAT /recurse /ForceUnsigned
DISM /image:E:\Images\WinREMount /Add-Driver /Driver:E:\Images\Drivers\WinPE /recurse /ForceUnsigned
DISM /image:E:\Images\Mount /Add-Driver /Driver:E:\Images\Drivers\RSTAT /recurse /ForceUnsigned
CLS
ECHO.
ECHO =========================================================
ECHO Creating Panther Directory
ECHO =========================================================
set "dirPath=E:\Images\Mount\Windows\Panther"
...
start powershell -NoProfile -ExecutionPolicy Bypass -File "E:\Images\Scripts\RemovePackages.ps1"
CLS
...
ECHO =========================================================
ECHO CALL DISM /image:E:\Images\WinREMount /Cleanup-image /StartComponentCleanup
CALL DISM /image:E:\Images\WinREMount /Cleanup-image /StartComponentCleanup
ECHO CALL DISM /unmount-image /mountdir:E:\Images\WinREMount /commit
CALL DISM /unmount-image /mountdir:E:\Images\WinREMount /commit
ECHO CALL DISM /unmount-image /mountdir:E:\Images\Mount /commit
CALL DISM /unmount-image /mountdir:E:\Images\Mount /commit
...
start powershell -NoExit -NoProfile -ExecutionPolicy Bypass -File "E:\Images\Scripts\RemovePackages.ps1"
CLS
ECHO  Please Wait for script to finish
goto MainMenu
