---
title: "Random DISM Commands Used to Build the Maintenance Task"
author: "Jeff Downs"
date: \today
toc: true
toc-depth: 3
...
## Purpose:This document lists common DISM and related commands used in Windows image servicing tasks, including exporting, mounting, injecting drivers, and removing built-in apps.

***Note:*** This was the basis for my maintenance task that was created
